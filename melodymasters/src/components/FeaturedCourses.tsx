    ...
    render() {
        ...
        return (
            <div className='py-12 bg-gray-900 text-white'>
                ...
                <div className='p-4 m-4 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-2 gap-8 justify-center'>
                ...
                <div className='mt-20 text-center'>
                    <Link className="px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white
                     hover:bg-gray-100 transition duration-200" href={"/courses"}> View All Courses  </Link>
                </div>
